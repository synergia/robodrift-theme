...
(function ($, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            var closeLink = $('<a href="#close" aria-hidden="true" title="Zamknij" class="pop-up-close-trigger">Zamknij</a>').click(function (e) {
                e.preventDefault();
            ...
            if (hasButtons) {
                ...
                $.each(this.options.buttons, function (index, item) {
                    ...
                    var button = $('<a href="#" class="' + cssClass + '">Zamknij</a>').click(function (e) {
                        e.preventDefault();
